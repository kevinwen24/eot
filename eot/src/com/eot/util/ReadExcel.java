               ...
               if (null != cell){
            	  ...
            	  System.out.println(val);
                   if(c==0){
                	   ...
                	   student.setGender(val);
                   }else if(c==3){
                	   student.setGrade(val);
                   }else if(c==4){
                	   student.setDeptName(val);
                   }else if(c==5){
                	   student.setMajorName(val);
                   }else if(c==6){
                	   student.setClassIndex(Integer.parseInt(val));
                   }else if(c==7){
                	   student.setPhone(val);
                   }
               }
           }
           //添加客户
